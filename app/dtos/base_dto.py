...
class BaseFilterDTO(BaseModel):
    ...
    userCreate: Optional[int] = Field(..., description="ID del usuario que creó el registro")
    userUpdate: Optional[int] = Field(..., description="ID del usuario que actualizó el registro")
    dateCreate: Optional[datetime] = Field(..., description="Fecha en la que se creó el registro")
    dateUpdate: Optional[datetime] = Field(..., description="Fecha en la que se actualizó el registro")
...
class BaseAuditDTO(BaseModel):
    ...
    dateUpdate: datetime = Field(..., description="Fecha en la que se actualizó el registro")
